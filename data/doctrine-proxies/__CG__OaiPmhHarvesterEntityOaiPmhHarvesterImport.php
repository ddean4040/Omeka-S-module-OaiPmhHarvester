 ...
 */
class OaiPmhHarvesterImport extends \OaiPmhHarvester\Entity\OaiPmhHarvesterImport implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OaiPmhHarvesterImport $proxy) {
