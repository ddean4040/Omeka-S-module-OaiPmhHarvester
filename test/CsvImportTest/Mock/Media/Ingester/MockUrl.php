<?php
namespace OaiPmhHarvesterTest\Mock\Media\Ingester;
...
class MockUrl extends Url
{
    ...
    public function ingest(Media $media, Request $request, ErrorStore $errorStore)
    {
        ...
        if (strpos($uri, 'http://localhost/') !== 0) {
            ...
            $uri = $extension === 'png'
                ? 'http://localhost/modules/OaiPmhHarvester/test/CsvImportTest/_files/image_test_1.png'
                : 'http://localhost/modules/OaiPmhHarvester/test/CsvImportTest/_files/image_test.jpg';
        }
